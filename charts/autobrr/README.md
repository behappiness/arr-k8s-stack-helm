...
![Version: 0.1.4](https://img.shields.io/badge/Version-0.1.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.86.0](https://img.shields.io/badge/AppVersion-v1.86.0-informational?style=flat-square)
...
| image.tag | string | `"v1.86.0"` | Image tag. Pin this in production. |
