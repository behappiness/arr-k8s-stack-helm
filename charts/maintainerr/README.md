...
![Version: 0.1.9](https://img.shields.io/badge/Version-0.1.9-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 3.29.0](https://img.shields.io/badge/AppVersion-3.29.0-informational?style=flat-square)
...
| image.tag | string | `"3.29.0"` | Image tag. Pin this in production. |
