...
![Version: 0.1.6](https://img.shields.io/badge/Version-0.1.6-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.6.5.5623-ls162](https://img.shields.io/badge/AppVersion-2.6.5.5623--ls162-informational?style=flat-square)
...
| image.tag | string | `"2.6.5.5623-ls162"` | Image tag. Pin this in production. |
