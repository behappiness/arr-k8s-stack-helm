...
![Version: 0.1.5](https://img.shields.io/badge/Version-0.1.5-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.10.8](https://img.shields.io/badge/AppVersion-2.10.8-informational?style=flat-square)
...
| image.tag | string | `"2.10.8"` | Image tag. Pin this in production. |
