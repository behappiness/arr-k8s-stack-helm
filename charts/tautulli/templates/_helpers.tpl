...
*/}}
{{- define "tautulli.configClaimName" -}}
{{- if .Values.persistence.config.existingClaim }}
{{- .Values.persistence.config.existingClaim }}
{{- else }}
{{- printf "%s-config" (include "tautulli.fullname" .) }}
{{- end }}
{{- end }}
...
{{- fail "tautulli: replicaCount must be 1. Tautulli is a single-instance application backed by an RWO volume; running multiple replicas corrupts its database." }}
{{- end }}
{{- end }}
