...
![Version: 0.1.0](https://img.shields.io/badge/Version-0.1.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.0.9](https://img.shields.io/badge/AppVersion-2.0.9-informational?style=flat-square)
...
| image.repository | string | `"ghcr.io/dictionarry-hub/profilarr"` | Image repository. This is the image published by the Profilarr project itself. |
| image.tag | string | `"2.0.9"` | Image tag. Pin this in production. |
| imagePullSecrets | list | `[]` | Image pull secrets |
| ingress.annotations | object | `{}` | Ingress annotations |
| ingress.className | string | `""` | IngressClass name |
| ingress.enabled | bool | `false` | Create an Ingress |
| ingress.hosts | list | `[{"host":"profilarr.local","paths":[{"path":"/","pathType":"Prefix"}]}]` | Ingress hosts |
...
| resources | object | `{"limits":{"memory":"1Gi"},"requests":{"cpu":"25m","memory":"512Mi"}}` | Resource requests and limits |
...
| service.port | int | `6868` | Service port. The container always listens on 6868. |
