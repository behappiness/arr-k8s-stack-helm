...
![Version: 0.1.10](https://img.shields.io/badge/Version-0.1.10-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.10.0.31](https://img.shields.io/badge/AppVersion-4.10.0.31-informational?style=flat-square)
...
| env.GID | int | `1000` | GID Emby Server runs as |
| env.TZ | string | `"Etc/UTC"` | Timezone. Ignored if a webhook like k8tz injects one. |
| env.UID | int | `1000` | UID Emby Server runs as |
...
| image.tag | string | `"4.10.0.31"` | Image tag. Pin this in production. |
| imagePullSecrets | list | `[]` | Image pull secrets |
| ingress.annotations | object | `{}` | Ingress annotations |
| ingress.className | string | `""` | IngressClass name |
| ingress.enabled | bool | `false` | Create an Ingress |
| ingress.hosts | list | `[{"host":"emby.local","paths":[{"path":"/","pathType":"Prefix"}]}]` | Ingress hosts |
| ingress.tls | list | `[]` | Ingress TLS configuration |
| livenessProbe | object | `{"enabled":true,"failureThreshold":3,"httpGet":{"path":"/System/Info/Public","port":"http"},"initialDelaySeconds":0,"periodSeconds":10,"timeoutSeconds":5}` | Liveness probe. `/System/Info/Public` answers without authentication. |
...
| persistence.cache.mountPath | string | `"/cache"` | Mount path |
...
| persistence.config.enabled | bool | `true` | Persist Emby's configuration directory (`/config`) |
...
| readinessProbe | object | `{"enabled":true,"failureThreshold":3,"httpGet":{"path":"/System/Info/Public","port":"http"},"initialDelaySeconds":0,"periodSeconds":10,"timeoutSeconds":5}` | Readiness probe |
...
| startupProbe | object | `{"enabled":true,"failureThreshold":60,"httpGet":{"path":"/System/Info/Public","port":"http"},"initialDelaySeconds":5,"periodSeconds":5,"timeoutSeconds":5}` | Startup probe. Generous by default: first start migrates the database and large libraries take a while. |
