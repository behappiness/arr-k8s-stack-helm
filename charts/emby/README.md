...
![Version: 0.1.0](https://img.shields.io/badge/Version-0.1.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.10.0.22](https://img.shields.io/badge/AppVersion-4.10.0.22-informational?style=flat-square)
...
| image.tag | string | `"4.10.0.22"` | Image tag. Pin this in production. |
