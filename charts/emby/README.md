...
![Version: 0.1.12](https://img.shields.io/badge/Version-0.1.12-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.11.0.1](https://img.shields.io/badge/AppVersion-4.11.0.1-informational?style=flat-square)
...
| image.tag | string | `"4.11.0.1"` | Image tag. Pin this in production. |
