...
![Version: 0.1.6](https://img.shields.io/badge/Version-0.1.6-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.6.0-ls361](https://img.shields.io/badge/AppVersion-v1.6.0--ls361-informational?style=flat-square)
...
| image.tag | string | `"v1.6.0-ls361"` | Image tag. Pin this in production. |
