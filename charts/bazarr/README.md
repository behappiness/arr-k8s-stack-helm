...
![Version: 0.1.8](https://img.shields.io/badge/Version-0.1.8-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.6.0-ls363](https://img.shields.io/badge/AppVersion-v1.6.0--ls363-informational?style=flat-square)
...
| image.tag | string | `"v1.6.0-ls363"` | Image tag. Pin this in production. |
