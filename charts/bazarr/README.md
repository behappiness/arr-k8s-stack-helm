...
![Version: 0.1.5](https://img.shields.io/badge/Version-0.1.5-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.6.0-ls360](https://img.shields.io/badge/AppVersion-v1.6.0--ls360-informational?style=flat-square)
...
| image.tag | string | `"v1.6.0-ls360"` | Image tag. Pin this in production. |
