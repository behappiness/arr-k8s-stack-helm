...
![Version: 0.1.7](https://img.shields.io/badge/Version-0.1.7-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.6.0-ls362](https://img.shields.io/badge/AppVersion-v1.6.0--ls362-informational?style=flat-square)
...
| image.tag | string | `"v1.6.0-ls362"` | Image tag. Pin this in production. |
